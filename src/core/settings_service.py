...
class SettingsService:
    ...
    def _initialize_setting_definitions(self):
        ...
        logger.info(f"Initialized {sum(len(defs) for defs in self._setting_definitions.values())} setting definitions")
    
    def get_user_setting(self, user_id: int, category: str, key: str, 
    ...
    def set_user_setting(self, user_id: int, category: str, key: str, value: Any,
            ...
            with self._lock:
                ...
                if self.database_manager:
                    ...
                    if success:
                        ...
                        # Log setting change
                        self._log_setting_change(user_id, category, key, old_value, value, setting_def)
    ...
    def get_all_user_settings(self, user_id: int, use_cache: bool = True) -> Dict[str, Dict[str, Any]]:
        """
    ...
    def import_user_settings(self, user_id: int, settings_data: Dict[str, Any], 
        ...
        logger.info(f"Settings import for user {user_id}: {imported_count} imported, {error_count} errors")
        return result
    ...
    def _validate_setting_value(self, setting_def: SettingDefinition, value: Any) -> bool:
        ...
        try:
            ...
            if setting_def.setting_type == SettingType.BOOLEAN and not isinstance(value, bool):
                ...
                return False
            elif setting_def.setting_type == SettingType.FLOAT and not isinstance(value, (int, float)):
                return False
            elif setting_def.setting_type == SettingType.LIST and not isinstance(value, list):
                return False
            elif setting_def.setting_type == SettingType.JSON and not isinstance(value, (dict, list)):
                return False
    ...
    def _log_setting_change(self, user_id: int, category: str, key: str, 
                          old_value: Any, new_value: Any, setting_def: SettingDefinition):
    ...
    def _notify_setting_changed(self, user_id: int, category: str, key: str, 
...
if __name__ == "__main__":
    ...
    # Test validation
    is_valid = settings_service.validate_setting_value("password_viewing", "view_timeout_minutes", 5)
    print(f"Validation test (5 minutes): {is_valid}")
    
    is_invalid = settings_service.validate_setting_value("password_viewing", "view_timeout_minutes", 100)
