    ...
    def _register_routes(self):
                    ...
                    return jsonify(
                        {
                            ...
                            "password": {
                                ...
                                "created_at": password_data.created_at.isoformat()
                                if password_data.created_at
                                else None,
                                "updated_at": password_data.updated_at.isoformat()
                                if password_data.updated_at
                                else None,
                            },
                        }
                    )
        ...
        def search():
            ...
            try:
                ...
                return render_template(
                    "search_results.html", query=query, results=results, result_count=len(results)
                )
        ...
        def api_create_backup():
            ...
            try:
                ...
                return jsonify(
                    {"success": True, "message": "Backup created successfully", "path": backup_path}
                )
            except Exception as e:
                ...
                return jsonify(
                    {
                        ...
                        "download_url": url_for(
                            "download_export", filename=os.path.basename(export_path)
                        ),
                    }
                )
        ...
        def api_password_health():
            ...
            try:
                ...
                return jsonify({"success": True, "health_analysis": health_analysis})
    ...
    def _analyze_password_health(self, passwords):
        ...
        for password in passwords:
            ...
            if password_hash in password_hashes:
                ...
                password_hashes[password_hash] = {"id": password.id, "website": password.website}
...
if __name__ == "__main__":
    # Development server
    config = {"DEBUG": True, "SECRET_KEY": "dev-key-change-in-production"}
