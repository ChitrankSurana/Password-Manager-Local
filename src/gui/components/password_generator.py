...
from ..themes import create_themed_button, create_themed_entry, create_themed_label, get_theme
...
class PasswordGeneratorDialog(ctk.CTkToplevel):
    ...
    def _create_ui(self):
        ...
        # Length slider
        length_label = create_themed_label(
            options_frame, f"Length: {
                self.length_var.get()}", "label")
                ...
                for child in widget.winfo_children():
                    if isinstance(child, ctk.CTkFrame):
                        for grandchild in child.winfo_children():
                            if isinstance(
                                    grandchild, ctk.CTkLabel) and "Length:" in str(
