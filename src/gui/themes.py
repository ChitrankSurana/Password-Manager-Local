...
class ThemeManager:
    ...
    def __init__(self, theme_config_path: str = "data/theme_config.json"):
        ...
        logger.info(f"Theme manager initialized: {self.current_mode.value} mode, {self.current_scheme.value} scheme")
    ...
    def get_fonts(self) -> Dict[str, Tuple[str, int, str]]:
        """
        Get font definitions for the current theme
        ...
        return {
            # Heading fonts
            "heading_large": ("Segoe UI", 24, "bold"),      # Page titles
            "heading_medium": ("Segoe UI", 20, "bold"),     # Section headers
            "heading_small": ("Segoe UI", 16, "bold"),      # Subsection headers
            
            # Body fonts
            "body_large": ("Segoe UI", 14, "normal"),       # Large body text
            "body_medium": ("Segoe UI", 12, "normal"),      # Standard body text
            "body_small": ("Segoe UI", 10, "normal"),       # Small body text
            
            # UI fonts
            "button": ("Segoe UI", 12, "normal"),           # Button text
            "label": ("Segoe UI", 11, "normal"),            # Form labels
            "input": ("Segoe UI", 12, "normal"),            # Input fields
            "caption": ("Segoe UI", 9, "normal"),           # Captions, hints
            
            # Monospace fonts
            "code": ("Consolas", 11, "normal"),             # Code, passwords
            "code_small": ("Consolas", 9, "normal"),        # Small code text
        }
    ...
    def set_theme_mode(self, mode: ThemeMode):
        ...
        logger.info(f"Theme mode changed to: {mode.value}")
...
def create_themed_button(parent, text: str, style: str = "button_primary", **kwargs) -> ctk.CTkButton:
