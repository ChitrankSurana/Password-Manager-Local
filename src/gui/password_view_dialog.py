...
class PasswordViewAuthDialog:
    ...
    def _authenticate(self):
        ...
        try:
            ...
            if success and permission:
                ...
                messagebox.showinfo(
                    "Authentication Successful",
                    f"Password viewing enabled for {
                        self.timeout_var.get()} minutes.")

            else:
                # Authentication failed
                logger.warning(
                    f"Password view authentication failed for user {
            ...
            try:
                ...
                if success:
                    ...
                    messagebox.showwarning(
                        "Revocation Failed",
                        "Could not end the viewing session.")
    ...
    def _update_countdown_display(self, remaining_seconds: int):
        ...
        # Update status
        self.status_var.set("✅ Authentication active - passwords visible")
...
if __name__ == "__main__":
    ...
    def test_dialog():
        ...
        messagebox.showinfo(
            "Test",
            "In a real implementation, this would show the auth dialog with service integration.")
