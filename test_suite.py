...
class PasswordManagerTestSuite:
    ...
    def cleanup_test_environment(self):
        ...
        if self.test_dir and os.path.exists(self.test_dir):
            ...
            print_colored("Cleaned up test environment", Colors.BLUE)
    ...
    def test_security_measures(self):
        ...
        try:
            ...
            if time_ratio > 10:  # Allow some variance but not too much
                print_colored(
                    f"Warning: Potential timing attack vulnerability (ratio: {
                        time_ratio:.2f})", Colors.YELLOW)
    ...
    def run_all_tests(self):
        ...
        print_colored("Starting comprehensive testing...\n", Colors.WHITE)
        ...
        if self.failed_tests == 0:
            print_colored(
                "\n🎉 ALL TESTS PASSED! The Password Manager is ready for use.",
                Colors.GREEN)
        else:
